...
export function poundsOuncesToGrams(poundsOunces) {
    const grams = poundsOunces.pounds * GRAMS_PER_POUND + poundsOunces.ounces * GRAMS_PER_OUNCE;
    return grams;
}